        ...
        for field in implicit_fields :
            if field.name not in explicit_fields:
                ...
                if issubclass(klass,(models.ForeignKey,models.OneToOneField)):
                    ...
                    field_obj = DecimalField(max_digits=field.max_digits,decimal_places=field.decimal_places)
                else:
                    try:
                        field.get_choices()
                ...
                if field.has_default():
                    field_obj.default_value = field.default.value if hasattr(field.default,'value') else field.default
    ...
    def __new__(cls, name, bases, attrs):
        ...
        if meta:
            ...
            if hasattr(model, "_meta"):
                ...
                declared_fields = cls._filter_fields(cls,
                    declared_fields, explicit_fields, implicit_fields
                )
