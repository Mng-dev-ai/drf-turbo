...
class FieldValues:
    ...
    def test_valid_inputs(self):
        ...
        for input_value, expected_output in get_items(self.valid_inputs):
            assert self.field.run_validation(input_value,self.context) == expected_output, \
    ...
    def test_outputs(self):
        for output_value, expected_output in get_items(self.outputs):
            assert self.field.serialize(output_value,self.context) == expected_output, \
...
class TestAllowNullNoStringCoercionDecimalField(FieldValues):
    ...
    field = dt.DecimalField(max_digits=3, decimal_places=1, allow_null=True, coerce_to_string=False)
...
class TestManyRelatedField(APISimpleTestCase):
    ...
    def setUp(self):
        ...
        self.instance = self.queryset.items[2]
        self.field = dt.ManyRelatedField(child_relation=self.child_relation,allow_empty=False)
